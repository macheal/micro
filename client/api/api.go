...
import (
	...
	ahandler "gitee.com/smartsteps/go-micro/v2/api/handler"
	aapi "gitee.com/smartsteps/go-micro/v2/api/handler/api"
	"gitee.com/smartsteps/go-micro/v2/api/handler/event"
	ahttp "gitee.com/smartsteps/go-micro/v2/api/handler/http"
	arpc "gitee.com/smartsteps/go-micro/v2/api/handler/rpc"
	"gitee.com/smartsteps/go-micro/v2/api/handler/web"
	"gitee.com/smartsteps/go-micro/v2/api/resolver"
	"gitee.com/smartsteps/go-micro/v2/api/resolver/grpc"
	"gitee.com/smartsteps/go-micro/v2/api/resolver/host"
	"gitee.com/smartsteps/go-micro/v2/api/resolver/path"
	"gitee.com/smartsteps/go-micro/v2/api/router"
	regRouter "gitee.com/smartsteps/go-micro/v2/api/router/registry"
	"gitee.com/smartsteps/go-micro/v2/api/server"
	"gitee.com/smartsteps/go-micro/v2/api/server/acme"
	"gitee.com/smartsteps/go-micro/v2/api/server/acme/autocert"
	"gitee.com/smartsteps/go-micro/v2/api/server/acme/certmagic"
	httpapi "gitee.com/smartsteps/go-micro/v2/api/server/http"
