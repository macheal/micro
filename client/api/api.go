...
import (
	...
	ahandler "github.com/macheal/go-micro/v2/api/handler"
	aapi "github.com/macheal/go-micro/v2/api/handler/api"
	"github.com/macheal/go-micro/v2/api/handler/event"
	ahttp "github.com/macheal/go-micro/v2/api/handler/http"
	arpc "github.com/macheal/go-micro/v2/api/handler/rpc"
	"github.com/macheal/go-micro/v2/api/handler/web"
	"github.com/macheal/go-micro/v2/api/resolver"
	"github.com/macheal/go-micro/v2/api/resolver/grpc"
	"github.com/macheal/go-micro/v2/api/resolver/host"
	"github.com/macheal/go-micro/v2/api/resolver/path"
	"github.com/macheal/go-micro/v2/api/router"
	regRouter "github.com/macheal/go-micro/v2/api/router/registry"
	"github.com/macheal/go-micro/v2/api/server"
	"github.com/macheal/go-micro/v2/api/server/acme"
	"github.com/macheal/go-micro/v2/api/server/acme/autocert"
	"github.com/macheal/go-micro/v2/api/server/acme/certmagic"
	httpapi "github.com/macheal/go-micro/v2/api/server/http"
	log "github.com/macheal/go-micro/v2/logger"
	"github.com/macheal/go-micro/v2/sync/memory"
