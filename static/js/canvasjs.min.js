...
(function() {
    ...
    function za(a, b, c) {
        if (a && b && c) {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""), g = atob(g), k = new ArrayBuffer(g.length), p = new Uint8Array(k), l = 0; l < g.length; l++)
                    p[l] = g.charCodeAt(l);
                b = new Blob([k], {
                    type: "image/" + b
                });
    ...
    function T() {
        for (var a = null, b = 0; b < arguments.length; b++)
            (a = arguments[b]) && a.style && (a.style.display =
                "none")
    }
    function F(a, b, c, d) {
        this._defaultsKey = a;
    ...
    var t = !!document.createElement("canvas").getContext,
        ...
        X = function(a, b, c) {
                ...
                if (b = l.pop(), "#" === b || "0" === b)
                    if (p++, p === n) {
                        ...
                        for (; 0 <
                            ...
                            c = u.pop() + c,
                                t++,
                            0 === t % r && (k === q && 0 < u.length) && (c = f + c);
                        d && (c = "-" + c)
                    } else
                        0 < g.length ? (c = g.pop() + c, m++, t++) : "0" === b && (c = "0" + c, m++, t++),
                        0 === t % r && (k === q && 0 < g.length) && (c = f + c);
                else
                    "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? "," === b ? (k++, r = t, t = 0, 0 < g.length && (c = f + c)) : c = 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? b.slice(1, b.length - 1) + c : b + c : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), c += b.replace(/[0]+/, function(a) {
                        return L(s,
                            a.length)
                    }));
            d = "";
            for (f = !1; 0 < h.length;)
                b = h.shift(),
                    "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) : 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? d += b.slice(1, b.length - 1) : "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? d += b : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), d += b.replace(/[0]+/, function(a) {
                        return L(s, a.length)
                    }));
            return c + ((f ? e : "") + d)
        },
    ...
    F.prototype.dispatchEvent = function(a, b) {
        if (a && this._eventListeners[a]) {
            ...
            for (var c = this._eventListeners[a], d = 0; d < c.length; d++)
                c[d].eventHandler.call(c[d].context, b)
        }
    };
    O(w, F);
    w.prototype._updateOptions = function() {
        ...
        if ("undefined" === typeof ma.Chart.creditHref)
    ...
    w.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
                this.data[a].axisYType && "primary" !== this.data[a].axisYType ? "secondary" === this.data[a].axisYType && (this.axisY2 || ("normal" === this.plotInfo.axisPlacement ? this.axisY2 = new x(this, this._options.axisY2, "axisY", "right") : "xySwapped" === this.plotInfo.axisPlacement && (this.axisY2 = new x(this, this._options.axisY2, "axisY",
                    "top"))), this.data[a].axisY = this.axisY2) : (this.axisY || ("normal" === this.plotInfo.axisPlacement ? this.axisY = new x(this, this._options.axisY, "axisY", "left") : "xySwapped" === this.plotInfo.axisPlacement && (this.axisY = new x(this, this._options.axisY, "axisY", "bottom"))), this.data[a].axisY = this.axisY),
                this.axisX || ("normal" === this.plotInfo.axisPlacement ? this.axisX = new x(this, this._options.axisX, "axisX", "bottom") : "xySwapped" === this.plotInfo.axisPlacement && (this.axisX = new x(this, this._options.axisX, "axisX", "left"))),
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
            x.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
        ...
        0 < d.length ? (p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function(a) {
            ...
            for (var c = 0; c < d.length; c++)
                g = d[c],
                    1 > a && "undefined" !== typeof g.startTimePercent ? a >= g.startTimePercent && g.animationCallback(g.easingFunction(a -
    ...
    w.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes &&
            ...
            for (h in k)
                isNaN(h) || (a = k[h], a < b.min && (b.min = a), a > b.max && (b.max = a), h < c.viewPortMin || h > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)))
        }
    };
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) {
                    ...
                    this.zoomEnabled && (c = this.plotArea, this.resetOverlayedCanvas(), d = this.overlaidCanvasCtx.globalAlpha, this.overlaidCanvasCtx.globalAlpha = 0.7, this.overlaidCanvasCtx.fillStyle = "#A0ABB8", "xySwapped" === this.plotInfo.axisPlacement ? this.overlaidCanvasCtx.fillRect(c.x1,
    ...
    w.prototype.renderIndexLabels = function(a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = g = e = 0, p = 0; p < this._indexLabels.length; p++) {
            ...
            if (0 <= l.dataSeries.type.indexOf("stacked") || "pie" === l.dataSeries.type || "doughnut" === l.dataSeries.type)
                r = this.getPercentAndTotal(l.dataSeries, l.dataPoint);
            ...
            if (null !== t && "" !== t) {
                ...
                if (0 <= f.indexOf("line") || 0 <= f.indexOf("area") || 0 <= f.indexOf("bubble") || 0 <= f.indexOf("scatter")) {
                    if (l.dataPoint.x < u.minimum || l.dataPoint.x > u.maximum || l.dataPoint.y < v.minimum || l.dataPoint.y > v.maximum)
                        continue
                } else if (l.dataPoint.x < u.minimum || l.dataPoint.x > u.maximum)
                    continue;
                e = g = 2;
                "horizontal" === r ? (d = m.width, k = m.height) : (k = m.width, d = m.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= f.indexOf("line") || 0 <= f.indexOf("area"))
                        c = "auto",
                            g = 4;
                    else if (0 <= f.indexOf("stacked"))
                        "auto" === c && (c = "inside");
                    else if ("bubble" === f || "scatter" === f)
                        c = "inside";
                    h = l.point.x - d / 2;
                ...
                if (0 < k.length) {
                    for (var q = !1, h = 0; h < k.length; h++)
                        if (n = k[h].x.getTime ? k[h].x.getTime() : k[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[h].y)
                                0 < h && (b.stroke(), t && c.stroke()),
                                    q =
                                        !0;
                            else {
                    ...
                    for (var q = !1, h = 0; h < k.length; h++)
                        if (n = k[h].getTime ? k[h].x.getTime() : k[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !==
                                ...
                                if (0 < k[h].markerSize || 0 < g.markerSize)
                                    r = g.getMarkerProperties(h, n, m, b),
                                        d.push(r),
                                        s = A(s),
                                    t && d.push({
                                        x: n,
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3)
                    c.bezierCurveTo(a[b + 1].x,
                        a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                var g = [],
                    ...
                    m,
                    q,
                    r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) +
                        0.5 << 0,
                    s,
                    z = null,
                    u = [];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                for (k = 0; k < u.length; k++)
                    s = u[k].x.getTime ? u[k].x.getTime() : u[k].x,
                        z.dataPointIndexes[s] = k,
        ...
        if (!(0 >= c)) {
            ...
            for (var p = -Infinity, l = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                for (var n = a.dataSeriesIndexes[h],
                         m = this.data[n], q = m.dataPoints, r = 0, e = 0; e < q.length; e++)
                    f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x,
                    f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (r = q[e].z, r > p && (p = r), r < l && (l = r));
    ...
    w.prototype.renderScatter = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea,
                ...
                f,
                g,
                k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width <<
                    0,
                e = a.axisX.dataInfo.minDiff,
                c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(e) / c) << 0;
            b.save();
        ...
        function b() {
            ...
            if (0 < a.length) {
                ...
                if (0 < k.lineThickness) {
                    ...
                    for (b = a.length - 1; 2 < b; b -= 3)
                        c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y),
                        t && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x,
    ...
    w.prototype.renderPie =
        function(a) {
                ...
                if (h && n) {
                    ...
                    for (x = 0; x < n.length; x++) {
                        ...
                        if (g.midAngle > Math.PI / 2 - v && g.midAngle < Math.PI / 2 + v) {
                            if (0 === a || s[c].midAngle > g.midAngle)
                                c = x;
                            a++
                        } else if (g.midAngle > 3 * Math.PI / 2 - v && g.midAngle < 3 * Math.PI / 2 + v) {
                            if (0 === b || s[d].midAngle > g.midAngle)
                                d = x;
                            b++
                        }
                    ...
                    for (x = 0; x < n.length; x++)
                        g = s[(c + x) % n.length],
                        1 < a && (g.midAngle > Math.PI / 2 - v && g.midAngle < Math.PI / 2 + v) && (e <= a / 2 && !k ? (g.hemisphere = "right", e++) : (g.hemisphere = "left", k = !0));
                    k = !1;
                    for (x = 0; x < n.length; x++)
                        g = s[(d + x) % n.length],
                        1 < b && (g.midAngle > 3 * Math.PI / 2 - v && g.midAngle < 3 * Math.PI / 2 + v) && (f <= b / 2 && !k ? (g.hemisphere = "left", f++) : (g.hemisphere = "right", k = !0))
                }
            }
            function c(a) {
                    ...
                    if (d > c) {
                        ...
                        if (n[b].exploded) {
                            if (1E-9 < Math.abs(s[b].center.x -
                                (y.x + e)) || 1E-9 < Math.abs(s[b].center.y - (y.y + f)))
                                s[b].center.x = y.x + e * a,
                                    s[b].center.y = y.y + f * a,
                                    g = !0
                        } else if (0 < Math.abs(s[b].center.x - y.x) || 0 < Math.abs(s[b].center.y - y.y))
                            s[b].center.x = y.x + e * (1 - a),
                                s[b].center.y = y.y + f * (1 - a),
                                g = !0;
            ...
            function f(a) {
                for (var b = null, c = 1; c < n.length; c++)
                    if (b = (a + c + s.length) % s.length, s[b].hemisphere !== s[a].hemisphere) {
                        b = null;
                        break
                    } else if (s[b].indexLabelText && b !== a && (0 > e(s[b], s[a]) || ("right" === s[a].hemisphere ? s[b].indexLabelTextBlock.y >= s[a].indexLabelTextBlock.y : s[b].indexLabelTextBlock.y <= s[a].indexLabelTextBlock.y)))
                        break;
                    else
                        b = null;
                return b
            ...
            function g(a, b) {
                ...
                if (0 <= a && a < n.length) {
                    var l = s[a];
                    if (0 > b && l.indexLabelTextBlock.y < d || 0 < b && l.indexLabelTextBlock.y > h)
                        return 0;
                    var k = b,
                        m = 0,
                        q = 0,
                    ...
                    for (h = 1; h < n.length; h++)
                        if (d = (a - h + s.length) % s.length, s[d].hemisphere !== s[a].hemisphere) {
                            d =
                                null;
                            break
                        } else if (s[d].indexLabelText && s[d].hemisphere === s[a].hemisphere && d !== a && (0 > e(s[d], s[a]) || ("right" === s[a].hemisphere ? s[d].indexLabelTextBlock.y <= s[a].indexLabelTextBlock.y : s[d].indexLabelTextBlock.y >= s[a].indexLabelTextBlock.y)))
                            break;
                        else
                            d = null;
                    q = d;
            ...
            function k() {
                ...
                for (var b = 0, c = a = 0, a = 0; 10 > a && (1 > a || 0 < c); a++) {
                    ...
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (var p, r, b = 0; b < n.length; b++) {
                            ...
                            if (null !== v) {
                                ...
                                var x = 0,
                                    x = e(p, r) - t;
                                if (0 > x) {
                                    for (var A = r = p = 0; A < n.length; A++)
                                        A !== b && s[A].hemisphere === k.hemisphere && (s[A].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? p++ : r++);
                                    A = x / (p + r || 1) * r;
                                    p = -1 * (x - A);
                                    var E = r = 0;
                        ...
                        for (b = 0; b < n.length; b++)
                            k = s[b],
                                B = "pie" === h.type ? 0.7 * D : 0.8 * D,
                                x = y.x + B * Math.cos(k.midAngle),
                                A = y.y + B * Math.sin(k.midAngle),
                                k.indexLabelTextBlock.x = x,
                                k.indexLabelTextBlock.y = A;
                    for (b = 0; b < n.length; b++)
                        k = s[b],
                            x = k.indexLabelTextBlock.measureText(),
                        0 !== x.height && 0 !== x.width && (x = x = 0, "right" === k.hemisphere ? (x = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + m), x *= -1) : x = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width -
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var h =
                    ...
                    x: (q.x2 + q.x1) / 2,
                    y: (q.y2 + q.y1) / 2
                }, D = "inside" === h.indexLabelPlacement ? 0.92 * Math.min(q.width, q.height) / 2 : 0.8 * Math.min(q.width, q.height) / 2, B = D * u, A = 0, x = 0; x < n.length; x++)
                    A += Math.abs(n[x].y);
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (!(0 >=
                    ...
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!h || h.width + Math.round(n.textBlock.width + 0.1 * this.horizontalSpacing + r + (0 === h.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                            h = {
                                items: [],
                                width: 0
                            },
    ...
    R.prototype.getDefaultAxisPlacement = function() {
        ...
        if ("column" === a || "line" === a || "stepLine" ===
            a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a)
            return "normal";
    ...
    x.prototype.createLabels = function() {
        ...
        if ("bottom" === this._position || "top" === this._position)
            b = this.lineCoordinates.width / Math.abs(this.maximum - this.minimum) * this.interval,
                ...
                e = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.5 * this.chart.height >>
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c =
                     ua(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalstartTimePercent; b < c; ua(b, this.interval, this.intervalType))
                a = b.getTime(),
                    ...
                    }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : sa(b, this.valueFormatString, this.chart._cultureInfo),
                    a = new G(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: d,
            ...
            for (b = this.intervalstartTimePercent; b <= c; b = parseFloat((b + this.interval).toFixed(14)))
                a = this.labelFormatter ? this.labelFormatter({
                    ...
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : X(b, this.valueFormatString, this.chart._cultureInfo),
                    a = new G(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: d,
        ...
        if ("undefined" === typeof this._options.interval) {
            if ("bottom" === this._position || "top" === this._position) {
                for (e = 0; e < this._labels.length; e++)
                    f = this._labels[e],
                    f.position < this.minimum || f.stripLine || (f = f.textBlock.width *
            ...
            if ("left" === this._position || "right" === this._position) {
                for (e = 0; e < this._labels.length; e++)
                    f = this._labels[e],
                    f.position < this.minimum || f.stripLine || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), b += f);
        ...
        if ("bottom" === this._position) {
            for (var e = 0, f, e = 0; e < this._labels.length; e++)
                if (f =
                    ...
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor),
                    ...
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
                        0 === f.textBlock.angle ? (b.x -= f.textBlock.width / 2, b.y += this.tickLength + f.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, b.y += this.tickLength + Math.abs(0 > this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                            f.textBlock.x = b.x,
                            f.textBlock.y = b.y,
                ...
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness,
                            this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor),
                            c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                            this.ctx.beginPath(),
                            this.ctx.moveTo(c, b.y << 0),
                            this.ctx.lineTo(c, b.y - this.tickLength << 0),
                    ...
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
                        ...
                        this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5 : 5)),
                            f.textBlock.x = b.x,
                            f.textBlock.y = b.y,
                            f.textBlock.render(!0)
                }
                ...
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ?
                            (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor),
                    ...
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
                        f.textBlock.x = b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5,
                            f.textBlock.y = 0 === this.labelAngle ? b.y : b.y - f.textBlock.width *
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    b = this.getPixelCoordinatesOnAxis(f.position);
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth =
                            c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor),
                            c = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0,
                            this.ctx.beginPath(),
                            this.ctx.moveTo(b.x << 0, c),
                            this.ctx.lineTo(b.x + this.tickLength << 0, c),
    ...
    x.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)
                this._labels[e].stripLine || (b ? (b = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 >= this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.maximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(b.x, d.y1, Math.abs(c.x - b.x), Math.abs(d.y1 - d.y2)), b = !1) : b = !0);
        else if (("left" === this._position ||
            "right" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)
                this._labels[e].stripLine || (b ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), b = e + 1 >= this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.maximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(d.x1, b.y, Math.abs(d.x1 - d.x2), Math.abs(b.y - c.y)), b = !1) : b = !0);
        a.beginPath()
    };
    ...
    x.prototype.renderAxisLine = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            "left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(M(this.lineDashType, this.lineThickness)),
    ...
    x.prototype.getPixelCoordinatesOnAxis = function(a) {
        ...
        if ("bottom" === this._position || "top" === this._position)
            c /= Math.abs(this.maximum - this.minimum),
                b.x = this.lineCoordinates.x1 + c * (a - this.minimum),
                b.y = this.lineCoordinates.y1;
        if ("left" === this._position || "right" ===
            this._position)
            c = d / Math.abs(this.maximum - this.minimum),
                b.y = this.lineCoordinates.y2 - c * (a - this.minimum),
    ...
    x.prototype.calculateValueToPixelconversionParameters = function(a) {
        ...
        if ("bottom" === this._position || "top" === this._position)
            a.pixelPerUnit = b / Math.abs(this.maximum - this.minimum),
                a.reference = this.lineCoordinates.x1;
        if ("left" === this._position || "right" === this._position)
            a.pixelPerUnit = -1 * c / Math.abs(this.maximum -
                this.minimum),
        ...
        if ("millisecond" !== this.intervalType)
            if ("second" === this.intervalType)
                ...
                if (0 < a.getDay() || 0 < a.getHours() || 0 < a.getMinutes() ||
                    0 < a.getSeconds() || 0 < a.getMilliseconds())
                ...
                "year" === this.intervalType && (0 < a.getMonth() || 1 < a.getDate() || 0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds()) &&
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex)
                        ...
                        if (!this.enabled || "line" !== d.type && "stepLine" !== d.type && "spline" !== d.type && "area" !== d.type && "stepArea" !==
                            d.type && "splineArea" !== d.type && "stackedArea" !== d.type && "stackedArea100" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !== d.type && "candlestick" !== d.type && "ohlc" !== d.type)
                            return;
                ...
                if (f = "", f = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : t ? "rgba(255,255,255,.9)" : "rgb(255,255,255)",
                            this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.borderColor ? this.borderColor : e[0].dataPoint.color ?
                                e[0].dataPoint.color : e[0].dataSeries.color ? e[0].dataSeries.color : e[0].dataSeries._colorSet[e[0].index % e[0].dataSeries._colorSet.length],
                            ...
                            this.container.style.borderRadius = this.contentDiv.style.borderRadius,
                            this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize +
                                "px" : "14px",
    ...
    Q.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))
            ...
            for (var p = "", k = 0; k < a.length; k++)
                if (c = a[k].dataSeries, d = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type ||
                        "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type)
            ...
            if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" ===
                c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type)
                ...
                f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === c.type || "ohlc" === c.type)
                f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") +
    ...
    w.prototype.getPercentAndTotal = function(a, b) {
        ...
        if (0 <= a.type.indexOf("stacked"))
            ...
            c in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[c], e = isNaN(b.y) ? 0 : 0 === d ? 0 : 100 * (b.y / d));
    ...
    w.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            h = null;
            if ("color" === a)
                return b.color ? b.color : c.color ? c.color : c._colorSet[d %
                c._colorSet.length];
    ...
    var y = {
        ...
        Aa = {
            ...
            formatNumber: function(a, b, c) {
                c = c || "en";
                if (ea[c])
                    return X(a, b || "#,##0.##", new da(c));
                throw "Unknown Culture Name";
            },
            formatDate: function(a, b, c) {
                c = c || "en";
                if (ea[c])
                    return sa(a, b || "DD MMM YYYY", new da(c));
                throw "Unknown Culture Name";
            }
        };
