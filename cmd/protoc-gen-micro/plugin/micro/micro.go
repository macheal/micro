...
const (
	apiPkgPath     = "gitee.com/smartsteps/go-micro/v2/api"
	contextPkgPath = "context"
	clientPkgPath  = "gitee.com/smartsteps/go-micro/v2/client"
	serverPkgPath  = "gitee.com/smartsteps/go-micro/v2/server"
)
